...
const PHASE_2_SCHEDULE: Phase2DaySchedule[] = [
  ...
  },
  {
    ...
    dayOfWeek: 'Wed',
    taskTitle: 'TEST #3 (ADVANCED TIER CHECKPOINT / full test)',
    whatItMeans: '8:00 AM - 10:24 AM: Full test right after finishing Advanced Tier & Phase 1 Math',
    category: 'test',
    taskId: 'p2-test-3',
    dayId: '2026-10-21',
  },
  {
    ...
    whatItMeans: '6:30 PM - 7:15 PM: Open score report, dissect every wrong question: skill & root-cause autopsy',
    category: 'review',
    taskId: 'w6-d4-autopsy',
    dayId: '2026-10-22',
  },
  {
    dateStr: '2026-10-23',
    ...
    whatItMeans: '6:30 PM - 7:45 PM: Targeted Math drills on Test #3 errors (45m) + Desmos speed drills on systems & roots (30m)',
    category: 'drill',
    taskId: 'w6-d5-1',
    dayId: '2026-10-23',
  },
  ...
  },
  {
    ...
    dayOfWeek: 'Sun',
    taskTitle: 'REST DAY',
    whatItMeans: 'Full day off, no studying. Mental reset before Test #4 week',
    category: 'rest',
    taskId: 'w6-buf-sun',
    dayId: '2026-10-25',
  },
  {
    ...
    whatItMeans: '6:30 PM - 7:15 PM: Only the weak spots still bothering you, nothing new before Test #4',
    category: 'drill',
    taskId: 'w7-d1-1',
    dayId: '2026-10-26',
  },
  {
    ...
    dayOfWeek: 'Tue',
    taskTitle: 'TEST #4 (full test, real conditions)',
    whatItMeans: '8:00 AM - 10:24 AM: Full real conditions, both sections, 10-min break included',
    category: 'test',
    taskId: 'p2-test-4',
    dayId: '2026-10-27',
  },
  {
    ...
    dayOfWeek: 'Wed',
    taskTitle: 'Error-log review of Test #4 (45 min)',
    whatItMeans: '6:30 PM - 7:15 PM: Same autopsy process as after Test #3, log every missed question',
    category: 'review',
    taskId: 'w7-d3-1',
    dayId: '2026-10-28',
  },
  {
    ...
    dayOfWeek: 'Thu',
    taskTitle: 'Targeted drills on Test #4 weak areas (60 min)',
    whatItMeans: '6:30 PM - 7:30 PM: Fix what Test #4 exposed with targeted Khan practice',
    category: 'drill',
    taskId: 'w7-d4-1',
    dayId: '2026-10-29',
  },
  ...
  },
  {
    ...
    dayOfWeek: 'Sat',
    taskTitle: 'TEST #5 (FINAL full test, timed)',
  ...
  },
  {
    ...
    dayOfWeek: 'Mon',
    taskTitle: 'Error-log review of Test #5 + simulate exact test-day timing (45 min)',
    whatItMeans: '6:30 PM - 7:15 PM: Error-log review of Test #5 + exact test-day timing simulation',
    category: 'test',
    taskId: 'w9-d1-2',
    dayId: '2026-11-02',
  },
...
export const BluebookArenaSection: React.FC<BluebookArenaSectionProps> = ({
  ...
  const mockTests = [
    ...
    { name: 'Bluebook Practice Test #3', date: 'Wed Oct 21', time: '8:00 AM - 10:24 AM', dayId: '2026-10-21', taskId: 'p2-test-3', tag: 'Advanced Checkpoint' },
    { name: 'Bluebook Practice Test #4', date: 'Tue Oct 27', time: '8:00 AM - 10:24 AM', dayId: '2026-10-27', taskId: 'p2-test-4', tag: 'Full Real Conditions' },
    { name: 'Bluebook Practice Test #5', date: 'Sat Oct 31', time: '8:00 AM - 10:24 AM', dayId: '2026-10-31', taskId: 'p2-test-5', tag: 'Final Full Rehearsal' },
