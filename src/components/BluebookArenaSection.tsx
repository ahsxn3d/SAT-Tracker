...
const PHASE_2_SCHEDULE: Phase2DaySchedule[] = [
  ...
  },
  {
    ...
    whatItMeans: '8:00 AM - 10:24 AM: Full Bluebook Practice Test #4, final full test under timed real conditions',
    category: 'test',
  ...
  },
  {
    ...
    dayOfWeek: 'Sun',
    taskTitle: 'REST DAY',
    whatItMeans: 'Full day off, zero studying. Guaranteed mental reset before final week',
    category: 'rest',
  ...
  },
  {
    ...
    whatItMeans: '6:30 PM - 7:15 PM: Dissect every wrong question on Test #4, root-cause autopsy across both Math and R&W',
    category: 'review',
    taskId: 'w8-d1-1',
    dayId: '2026-11-02',
  },
  {
    ...
    whatItMeans: '6:30 PM - 7:00 PM: Light taper, review error notebook + grammar rules. No heavy problem sets',
    category: 'taper',
    taskId: 'w8-d2-1',
    dayId: '2026-11-03',
  },
  {
    ...
    whatItMeans: '6:30 PM - 6:50 PM: Verify Bluebook app login, admission ticket printed, ID/CNIC ready',
    category: 'taper',
    taskId: 'w8-d3-1',
    dayId: '2026-11-04',
  },
  {
    ...
    whatItMeans: '6:30 PM - 6:50 PM: Very light review of top rules, then pack bag (ID, charger, snack, calculator)',
    category: 'taper',
    taskId: 'w8-d4-1',
    dayId: '2026-11-05',
  },
  {
    ...
    whatItMeans: 'Zero studying. Hydrate, eat well, relax, sleep early with 10:00 PM curfew',
    category: 'rest',
    taskId: 'w8-d5-1',
    dayId: '2026-11-06',
  },
  {
    ...
    dayOfWeek: 'Sat',
    taskTitle: 'EXAM DAY: Follow official admission ticket reporting time exactly',
    whatItMeans: 'Arrive at Crescent Model School, Shadman Lahore by 7:15 AM sharp (gates lock strictly at 7:45 AM). Execute with poise!',
    category: 'exam',
    taskId: 'sat-exam-day',
    dayId: '2026-11-07',
  },
