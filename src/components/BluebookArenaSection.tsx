...
const PHASE_2_SCHEDULE: Phase2DaySchedule[] = [
  ...
  },
  {
    ...
    dayOfWeek: 'Wed',
    taskTitle: 'TEST #2 (ADVANCED TIER CHECKPOINT / full test)',
  ...
  },
  {
    ...
    whatItMeans: '6:30 PM - 7:15 PM: Error-log review of Test #2: Open score report, dissect every wrong question: skill & root-cause autopsy',
    category: 'review',
    taskId: 'p2-d2-1',
    dayId: '2026-10-22',
  },
  {
    ...
    whatItMeans: '6:30 PM - 7:45 PM: Targeted Math drills on Test #2 errors (45m) + Desmos speed drills on systems & roots (30m)',
    category: 'drill',
    taskId: 'p2-d3-1',
    dayId: '2026-10-23',
  },
  {
    ...
    whatItMeans: '6:30 PM - 7:30 PM: Redo missed skills on Khan, review grammar rules & punctuation traps',
    category: 'drill',
    taskId: 'p2-d4-1',
    dayId: '2026-10-24',
  },
  ...
  },
  {
    ...
    whatItMeans: '6:30 PM - 7:15 PM: Only weak spots still bothering you, nothing new. Calm confidence builder',
    category: 'drill',
    taskId: 'p2-d6-1',
    dayId: '2026-10-26',
  },
  {
    ...
    dayOfWeek: 'Tue',
    taskTitle: 'TEST #3 (full test, real conditions)',
    whatItMeans: '8:00 AM - 10:24 AM: Full official test simulation, both sections with 10-min break',
    category: 'test',
  ...
  },
  {
    ...
    whatItMeans: '6:30 PM - 7:15 PM: Dissect every wrong question and log root-cause rules',
    category: 'review',
    taskId: 'p2-d8-1',
    dayId: '2026-10-28',
  },
  ...
  },
  {
    ...
    whatItMeans: '6:30 PM - 7:30 PM: High-leverage grammar trap patterns and math formula cleanup',
    category: 'review',
    taskId: 'p2-d10-1',
    dayId: '2026-10-30',
  },
  {
    ...
    dayOfWeek: 'Sat',
    taskTitle: 'Pre-Taper Final Polish (45 min)',
    whatItMeans: '6:30 PM - 7:15 PM: Review Desmos shortcuts and pacing benchmark rules',
    category: 'review',
    taskId: 'p2-d11-1',
    dayId: '2026-10-31',
  },
  ...
  },
  {
    ...
    dayOfWeek: 'Mon',
    taskTitle: 'TEST #4 (final full Bluebook Practice Test, real conditions)',
    whatItMeans: '8:00 AM - 10:24 AM: Final full Bluebook Practice Test, real conditions, both sections with 10-min break',
    category: 'test',
    taskId: 'bluebook-test-4',
    dayId: '2026-11-02',
  },
  {
    dateStr: '2026-11-03',
    ...
    dayOfWeek: 'Tue',
    taskTitle: 'Error-log review of Test #4 (both subjects)',
    whatItMeans: '6:30 PM - 7:15 PM: Write down every wrong question and why, both subjects. Root-cause mistake autopsy',
    category: 'review',
    taskId: 'w8-d2-1',
    dayId: '2026-11-03',
  },
  {
    ...
    dayOfWeek: 'Wed',
    taskTitle: 'Light targeted review: formula sheet + grammar summary',
    whatItMeans: '6:30 PM - 7:05 PM: Re-read your Math formula sheet + grammar rule summary. No new content, no drilling weak spots hard, just refresh',
    category: 'taper',
    taskId: 'w8-d3-1',
    dayId: '2026-11-04',
  },
  {
    ...
    dayOfWeek: 'Thu',
    taskTitle: 'Logistics only: app login, ticket, ID & pack bag',
    whatItMeans: '6:30 PM - 6:55 PM: Verify Bluebook app login, admission ticket, ID, pack your bag (ID/Smart CNIC, calculator if needed, charger, snack)',
    category: 'taper',
    taskId: 'w8-d4-1',
    dayId: '2026-11-05',
  },
  ...
  },
  {
    ...
    dayOfWeek: 'Sat',
    taskTitle: 'EXAM DAY: Crescent Model School (7:15 AM)',
...
export const BluebookArenaSection: React.FC<BluebookArenaSectionProps> = ({
  ...
  const mockTests = [
    ...
    { name: 'Bluebook Practice Test #4', date: 'Mon Nov 2', time: '8:00 AM - 10:24 AM', dayId: '2026-11-02', taskId: 'bluebook-test-4', tag: 'Final Real Conditions' },
  ];
